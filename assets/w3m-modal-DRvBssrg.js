import{du as x,dO as te,cN as c,cP as ne,cy as g,cz as j,cC as m,cD as b,cE as d,cB as l,dc as k,cY as z,dd as u,cA as se,cU as f,cG as D,da as L,dK as le,dA as V,cR as U,dr as R,d0 as F,cJ as ce,cO as A,dw as T,dH as q,db as de,cI as ie,dP as ue,dQ as he}from"./index-BeULVfBl.js";import{P as _}from"./index-BtKcqHAw.js";import{S as pe}from"./SwapController-CD0c_SW6.js";const oe={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){x.shake();return}if(await te.isSIWXCloseDisabled()){x.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&ne.disconnect(),x.close()}},me=g`
  :host {
    display: block;
...
`;var Y=function(e,t,i,r){var a=arguments.length,o=a<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,r);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(o=(a<3?n(o):a>3?n(t,i,o):n(t,i))||o);return a>3&&o&&Object.defineProperty(t,i,o),o};const be={info:"info",success:"checkmark",warning:"warningCircle",error:"warning"};let P=class extends b{constructor(){super(...arguments),this.message="",this.type="info"}render(){return d`
    ...
    `}onClose(){z.close()}};P.styles=[j,we];Y([l()],P.prototype,"message",void 0);Y([l()],P.prototype,"type",void 0);P=Y([m("wui-alertbar")],P);const ge=g`
  :host {
    display: block;
    position: absolute;
    top: ${({spacing:e})=>e[3]};
...
`;var X=function(e,t,i,r){var a=arguments.length,o=a<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,r);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(o=(a<3?n(o):a>3?n(t,i,o):n(t,i))||o);return a>3&&o&&Object.defineProperty(t,i,o),o};let O=class extends b{constructor(){super(),this.unsubscribe=[],this.paymentAsset=_.state.paymentAsset,this.amount=_.state.amount,this.unsubscribe.push(_.subscribeKey("paymentAsset",t=>{this.paymentAsset=t}),_.subscribeKey("amount",t=>{this.amount=t}))}disconnectedCallback(){this.unsubscribe.forEach(t=>t())}render(){const i=f.getAllRequestedCaipNetworks().find(r=>r.caipNetworkId===this.paymentAsset.network);return d`<wui-flex
    ...
    </wui-flex>`}};O.styles=[Ce];X([l()],O.prototype,"paymentAsset",void 0);X([l()],O.prototype,"amount",void 0);O=X([m("w3m-pay-header")],O);const $e=g`
  :host {
    height: 60px;
  }
...
`;var Oe=function(e,t,i,r){var a=arguments.length,o=a<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,r);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(o=(a<3?n(o):a>3?n(t,i,o):n(t,i))||o);return a>3&&o&&Object.defineProperty(t,i,o),o};let M=class extends b{constructor(){super()}render(){return d`
    ...
    `}onTryAgainClick(){c.goBack()}};M.styles=Pe;M=Oe([m("w3m-usage-exceeded-view")],M);const Ne=g`
  :host {
    width: 100%;
  }
