            ...
            >
              <PoolHeader>
                <PoolHeaderLeft>
                  ...
                  <PoolMeta>
                    <PoolCategory>{t(`activePools.categories.${pool.categoryKey}`)}</PoolCategory>
                    <PoolTitle>{t(pool.titleKey)}</PoolTitle>
                  </PoolMeta>
                </PoolHeaderLeft>
                <StatusBadge status={pool.status}>{t(`activePools.status.${pool.status}`)}</StatusBadge>
              </PoolHeader>

              <PoolDescription>{t(pool.descriptionKey)}</PoolDescription>

              <CoverageBox>
                <CoverageLabel>{t('activePools.labels.coverageCondition')}</CoverageLabel>
              ...
              <StatsRow>
                <StatItem>
                  ...
                  <StatValue>{formatCurrency(pool.premium, t('common.currency'))}</StatValue>
                </StatItem>
                <StatItem>
                  <StatLabel>{t('activePools.labels.maxPayout')}</StatLabel>
                  <StatValue highlight>{formatCurrency(pool.maxPayout, t('common.currency'))}</StatValue>
                </StatItem>
              </StatsRow>
              ...
              <StatsRow>
                <StatItem>
                  ...
                  <StatValue>{pool.members}{t('common.memberUnit')}</StatValue>
                </StatItem>
                <StatItem>
                  <StatLabel>
                    <ClockIcon />
              ...
              <PoolSizeContainer>
                <PoolSizeHeader>
                  <PoolSizeLabel>{t('activePools.labels.poolSize')}</PoolSizeLabel>
                  <PoolSizeValue>{formatCurrency(pool.poolSize, t('common.currency'))}</PoolSizeValue>
                </PoolSizeHeader>
                <ProgressBar>
                  <ProgressFill percent={(pool.poolSize / pool.poolTarget) * 100} />
                </ProgressBar>
              </PoolSizeContainer>
