...
const StepLabel = styled.div<{ $isActive: boolean }>`
  font-size: ${theme.fontSize.sm};
  font-weight: ${({ $isActive }) => $isActive ? theme.fontWeight.semibold : theme.fontWeight.medium};
  color: ${({ $isActive }) => $isActive ? theme.colors.text : theme.colors.textMuted};
  text-align: center;
`
...
const CheckIcon = () => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" width="18" height="18" strokeWidth="3">
      ...
      case 'RULES':
        return (
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }}>
            <BackLink onClick={handleBackToList}>{t('activeEvents.labels.backToEvents')}</BackLink>
            {renderStepper()}
            <GlassCard>
              <DashboardHeader>
                <IconWrapper rotate={45}>
                ...
                <div>
                  <CardTitle>{t(`activeEvents.events.${selectedEvent}.title`)}</CardTitle>
              ...
              <div style={{ marginTop: theme.spacing.xl }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: theme.spacing.lg }}>
                  <CardTitle style={{ fontSize: theme.fontSize.lg }}>{t('activeEvents.labels.episodeRules')}</CardTitle>
                ...
                <RulesGrid>
                  <RuleItem>
                    ...
                    <RuleContent>
                      <RuleTitle>1. {t('activeEvents.labels.coveredEvent')}</RuleTitle>
                      <RuleDetails>
                        <RuleDetailRow>
                          <RuleDetailLabel>{t('activeEvents.labels.event')}</RuleDetailLabel>
                          <RuleDetailValue>{t(`activeEvents.events.${selectedEvent}.title`)}</RuleDetailValue>
                        </RuleDetailRow>
                        <RuleDetailRow>
                          <RuleDetailLabel>{t('activeEvents.labels.eventWindow')}</RuleDetailLabel>
                          <RuleDetailValue>{t(`activeEvents.events.${selectedEvent}.time`)}</RuleDetailValue>
                        </RuleDetailRow>
                        <RuleDetailRow>
                          <RuleDetailLabel>{t('activeEvents.labels.triggerCondition')}</RuleDetailLabel>
                          <RuleDetailValue>{t(`activeEvents.events.${selectedEvent}.trigger`)}</RuleDetailValue>
                        </RuleDetailRow>
                      </RuleDetails>
                    </RuleContent>
                  </RuleItem>
                  ...
                  <RuleItem>
                    ...
                    <RuleContent>
                      <RuleTitle>2. {t('activeEvents.labels.oracle')}</RuleTitle>
                      <RuleDetails>
                        <RuleDetailRow>
                          <RuleDetailLabel>{t('activeEvents.labels.dataSource')}</RuleDetailLabel>
                          <RuleDetailValue>{t(`activeEvents.events.${selectedEvent}.oracle`)}</RuleDetailValue>
                        </RuleDetailRow>
                        <RuleDetailRow>
                          <RuleDetailLabel>{t('activeEvents.labels.resolutionTime')}</RuleDetailLabel>
                          <RuleDetailValue>{t(`activeEvents.events.${selectedEvent}.resolution`)}</RuleDetailValue>
                        </RuleDetailRow>
                      </RuleDetails>
                    </RuleContent>
                  </RuleItem>
                  ...
                  <RuleItem>
                    ...
                    <RuleContent>
                      <RuleTitle>3. {t('activeEvents.labels.financialTerms')}</RuleTitle>
                      <RuleDetails>
                        <RuleDetailRow>
        ...
        return (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <GlassCard>
              ...
              <TriggerBox>
                <TriggerText>{t(`activeEvents.events.${selectedEvent}.trigger`)}</TriggerText>
              </TriggerBox>
              ...
              <ActionRow>
                <Button variant="outline" onClick={() => setView('RULES')}>{t('activeEvents.labels.viewRulesShort')}</Button>
